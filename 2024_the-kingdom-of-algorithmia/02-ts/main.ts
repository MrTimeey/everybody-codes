...
import {part1, part2, part3} from "./src/runeService";
...
logPart('Part 1', part1, 'input_part1.txt', 27)
logPart('Part 2', part2, 'input_part2.txt', 5336)
logPart('Part 3', part3, 'input_part3.txt', 11845)
