...
import {part1, part2, part3} from "./src/nailService";
...
logPart('Part 1', part1, 'input_part1.txt', 76)
logPart('Part 2', part2, 'input_part2.txt', 843705)
logPart('Part 3', part3, 'input_part3.txt', 122361488)